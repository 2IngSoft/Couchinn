...
$tabla=$_POST["tabla"];
$tupla=$_POST["tupla"];
//echo "<input id='inicio' class='inicio' type='hidden' value='".."'>";
...
if(isset($_POST["tabla2"])){
  ...
  switch ($tabla2) {
    case 'PROVINCIAS':
    $sql=$sql." AND prov.idPROVINCIAS=".$tupla2;
    break;
    case 'CIUDADES':
    $sql=$sql." AND c.idCIUDADES=".$tupla2;
    break;
    case 'TIPOS_DE_HOSPEDAJES':
    $sql=$sql." AND t.idTIPOSDEHOSPEDAJES=".$tupla2;
    break;
    default:
    break;
  }
...
echo "<input id='inicio' class='inicio' type='hidden' value='".$_POST['inicio']."'>";
echo "<input id='escondido' class='escondido' type='hidden' value='".mysqli_num_rows($resultado)."'>";
//"<input id='escondido' class='escondido' type='hidden' value='".mysqli_num_rows($resultado)."'>";
