...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-06-2016 a las 20:21:55
...
CREATE TABLE `imagenes` (
  `idIMAGENES` mediumint(7) NOT NULL,
...
(1, 'imagenes_usuarios/phpE4D6_DER COUCH INN.jpg', 0),
(2, 'imagenes_usuarios/php5A44_DER COUCH INN.jpg', 0),
(6, 'imagenes_usuarios/phpA904_DER COUCH INN.jpg', 0),
(7, 'imagenes_usuarios/php2E06_DER COUCH INN.jpg', 0),
(8, 'imagenes_usuarios/php233A_iglucasas.jpg', 0);
...
(12, 10, '2016-06-28 13:27:06', 78),
(13, 11, '2016-06-28 13:46:12', 78),
(14, 9, '2016-06-28 13:52:57', 78),
(15, 8, '2016-06-28 13:58:06', 78),
(16, 13, '2016-06-28 18:18:49', 78),
(17, 12, '2016-06-28 21:16:39', 78);
...
CREATE TABLE `preguntasdeseguridad` (
  `idPREGUNTASDESEGURIDAD` smallint(5) NOT NULL,
...
INSERT INTO `preguntasdeseguridad` (`idPREGUNTASDESEGURIDAD`, `Pregunta`) VALUES
(1, '¿Cual es el nombre de tu mama?'),
(3, '¿Cual es el nombre del primer lugar donde vacacionaste?'),
(4, '¿Como se llamaba tu primer mascota?');
...
CREATE TABLE `publicaciones` (
  ...
  `idCIUDADES` int(11) NOT NULL,
  `CAPACIDAD` int(3) UNSIGNED NOT NULL,
  `FECHA_ALTA` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `DESCRIPCION` text CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `idTIPOS_DE_HOSPEDAJES` mediumint(9) NOT NULL,
  `Foto` text NOT NULL,
  `idUSUARIOS` int(11) UNSIGNED ZEROFILL NOT NULL,
  `idPUBLICACIONES` mediumint(5) UNSIGNED ZEROFILL NOT NULL,
...
INSERT INTO `publicaciones` (`TITULO`, `idCIUDADES`, `CAPACIDAD`, `FECHA_ALTA`, `DESCRIPCION`, `idTIPOS_DE_HOSPEDAJES`, `Foto`, `idUSUARIOS`, `idPUBLICACIONES`, `ACTIVA`, `FECHA_PUBLICADO`) VALUES
('Casa maravilosa de Catamarca', 330, 6, '2016-06-25 04:46:51', 'Hermosa casa con vista al mar. Contamos con todos los servicios para que su comodidad sea al maximo! ', 14, '', 00000000005, 00001, 1, '2016-06-29 18:10:11'),
('Jajajajjajajja', 286, 2, '2016-06-25 15:25:37', 'JNasljdnjlfnwljekfkjwnfklwenflkwen', 14, '', 00000000010, 00002, 1, '2016-06-29 18:10:11');
...
CREATE TABLE `tipos_de_hospedajes` (
  `idTIPOSDEHOSPEDAJES` mediumint(9) NOT NULL,
...
INSERT INTO `usuarios` (`NOMBRE`, `APELLIDO`, `FECHANAC`, `EMAIL`, `TELEFONO`, `CONTRASEÑA`, `RESPUESTASEG`, `idPREGUNTASDESEGURIDAD`, `idUSUARIOS`, `Premium`, `FECHADEALTA`) VALUES
('Facundo', 'Greco', '1995-05-25', 'facu.greco@gmail.com', 0, 'lala', 'Mar del Tuyu', 3, 5, 1, '2016-06-29 18:12:40'),
('Angelica', 'Portacelutti', '1990-06-21', 'angelica.portacelutti@gmail.com', 2147483647, 'Angelica', 'Gladis', 1, 6, 5, '2016-06-29 18:12:40'),
('Ivana', 'Andrade', '2016-06-01', 'ivana_boca@hotmail.com', 0, 'lolo', 'La Plata', 3, 8, 1, '2016-06-29 18:12:40'),
('Eliana', 'Ramirez', '2000-02-18', 'eliana.magali@gmail.com', 2147483647, 'escuela', 'Tito', 0, 9, 1, '2016-06-29 18:12:40'),
('Agustin', 'Perez', '1998-06-15', 'agustin_lp@hotmail.com', 0, 'facultad', 'Marta', 0, 10, 1, '2016-06-29 18:12:40'),
('Olivia', 'Cope', '1990-09-30', 'oli_cope@gmail.com', 0, 'olivia', 'La Plata', 0, 11, 1, '2016-06-29 18:12:40'),
('Jose ', 'Andrade', '1972-05-05', 'jose.andrade@gmail.com', 0, 'eliana', 'Tito', 0, 12, 1, '2016-06-29 18:12:40'),
('Ivana', 'Andrade', '1996-06-21', 'ivana_lp96@hotmail.com', 0, 'nicolas', 'Cordoba', 0, 13, 1, '2016-06-29 18:12:40');
...
ALTER TABLE `publicaciones`
  ...
  ADD KEY `IDTipoDeHospedaje` (`idTIPOS_DE_HOSPEDAJES`);
...
--
ALTER TABLE `imagenes`
  MODIFY `idIMAGENES` mediumint(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT de la tabla `pagos`
--
ALTER TABLE `pagos`
  MODIFY `IDPago` mediumint(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT de la tabla `preguntasdeseguridad`
--
ALTER TABLE `preguntasdeseguridad`
  MODIFY `idPREGUNTASDESEGURIDAD` smallint(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `publicaciones`
  MODIFY `idPUBLICACIONES` mediumint(5) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `tipos_de_hospedajes`
--
ALTER TABLE `tipos_de_hospedajes`
  MODIFY `idTIPOSDEHOSPEDAJES` mediumint(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
...
--
ALTER TABLE `publicaciones`
  ADD CONSTRAINT `IDTIPO_IDPOST` FOREIGN KEY (`idTIPOS_DE_HOSPEDAJES`) REFERENCES `tipos_de_hospedajes` (`idTIPOSDEHOSPEDAJES`) ON UPDATE CASCADE;
