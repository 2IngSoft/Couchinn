...
<html>
  <head>
    <meta charset="utf-8">
    <link rel="stylesheet" href="Estilos/Estilos_Detalle_Publicacion.css" media="screen" title="no title" charset="utf-8">
  ...
  <body>
    <div class="contenedor_publicacion_detalle">
      ...
      <div class="opcion_eliminar" onclick="reserva(<?php echo $publicacion; ?>)">
        Reservar
      </div>
    </div>
  </body>
