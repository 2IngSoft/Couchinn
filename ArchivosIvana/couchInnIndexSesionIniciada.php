...
<html>
  <head>
    ...
    <link rel="stylesheet" href="Estilos/Estilos_publicaciones_index.css" media="screen" title="no title" charset="utf-8">
    <link rel="stylesheet" href="Estilos/Estilos_Detalle_Publicacion_SC.css" media="screen" title="no title" charset="utf-8">
    <link rel="stylesheet" href="EStilos/Estilos_Contenedor_Fixed.css" media="screen" title="no title" charset="utf-8">
    ...
    <script>
      ...
      function reserva(idp){
        setTimeout ("$('#estadisticas_busqueda').hide(100)",0);
          $("#contenedor_publicaciones").hide(500);
            $("#filtros_busqueda_borde").hide();
        $("#contenedor_detalle").show(500).load("realizarReserva.php",{"publi":idp});
          $("#contenedor_fixed").show(500);
      }
      function buscar(){
        var frase=$("#cuadro_busqueda").val();
